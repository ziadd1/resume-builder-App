...
class createRecruiter extends StatefulWidget {
  // Add any required parameters or constructor

  @override
  createRecruiterState createState() => createRecruiterState();
}

class createRecruiterState extends State<createRecruiter> {
...
String _companyName='';
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      String signupError = await _authService.CreateRecruiter(
        authProvider,
        _username,
        _email,
        _password,
...
// Get the AuthProvider instance
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Recruiter Created Successfully'),
              actions: <Widget>[
                TextButton(
                  child: Text('OK'),
                  onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Create Recruiter',style: TextStyle(color: Colors.black),),
